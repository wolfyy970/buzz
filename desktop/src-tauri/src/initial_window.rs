...
pub(crate) async fn wait_for_stable_initial_window_geometry<R: tauri::Runtime>(
    ...
    for _ in 0..MAX_POLLS {
        // Accept whatever geometry the window-state plugin restores. macOS
        // applies it asynchronously, so consecutive identical outer bounds
        // are enough to know it settled.
